package org.eron.fxkotlin.temp;
...
public class Book {
    ...
    private long uniqueID;   //图书id唯一识别号
    private String name;  //图书名字
    private List<String> authors;  //作者s
    private int publishedYear;
    private boolean available;  //是否可以借出

    public String getAuthors() {  //a1_a2_a3
        String result = "";
    ...
    public void setAuthors(String authors) {  //set author
